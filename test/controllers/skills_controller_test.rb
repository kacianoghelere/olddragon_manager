...
class SkillsControllerTest < ActionController::TestCase
  ...
  test "should update skill" do
    patch :update, id: @skill, skill: { description: @skill.description, effect_id: @skill.effect_id, name: @skill.name, skill_type_id: @skill.skill_type_id, user_id: @skill.user_id }
    assert_redirected_to skill_path(assigns(:skill))
  end
